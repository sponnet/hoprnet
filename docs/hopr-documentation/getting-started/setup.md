...
4. Go to [Docker Hub](https://docs.docker.com/toolbox/overview/) to download **Docker Toolbox** to your computer.
5. Follow-up the wizard steps to ensure Docker is installed.
6. Ensure the installation was successful by running `docker ps`
7. Go to [Docker ](https://www.docker.com/products/docker-desktop)and download **Docker Desktop** to your computer.
8. Follow-up the wizard steps to ensure Docker is installed.
9. Ensure the installation was successful by running `docker ps`
...
![Currently HOPR Chat is about ~0.5 GB, please be patient.](../.gitbook/assets/docker_install_macos%20%283%29%20%281%29.gif)
...
![HOPR Chat distributed as a Docker image](../.gitbook/assets/docker_images%20%283%29%20%281%29.gif)
...
![](../.gitbook/assets/node%20%284%29%20%281%29.gif)
...
![](../.gitbook/assets/hopr%20%283%29%20%281%29.gif)
...
![Please select the correct distribution for your operating system.](../.gitbook/assets/image%20%288%29%20%283%29%20%281%29.png)
...
![The crawl command will show you other connected nodes.](../.gitbook/assets/running_hopr_chat_and_crawling%20%283%29%20%281%29.gif)
...
![Your message will be sent privately through the HOPR network](../.gitbook/assets/running_hopr_chat_and_sending%20%283%29%20%281%29.gif)
